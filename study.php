...
?>  
    <div class="container-fluid bg-dark"> <!-- Start Study MaterialPage Banner -->
      <div class="row">
        <img src="./image/book.avif" alt="study" style="height:500px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div> 
    </div> <!-- End Course Page Banner -->

    <div class="container mt-5"> <!-- Start All Course -->
      <h1 class="text-center">All Study Material</h1>
